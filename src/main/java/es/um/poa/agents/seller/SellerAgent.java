	...
	public void setup() {
		...
		if (args != null && args.length == 1) {
			...
			if(config != null) {
				...
				//protocolo para enviar capturas de pescados, deberÌa ser un cyclic si tenemos varios barcos, 
				...
				//protocolo para recepciÛn de pago. El vendedor recibir· un inform dado que antes le ha enviado un subscribe a la lonja
				...
				//sentido, serÌa mejor vaciarla al final. Pero si quieres simplemente seria poner un if, poner el dinero a 0 y sumar el pago despues
				seq.addSubBehaviour(new CyclicBehaviour() {
					...
					public void action() {
						...
						if (msg != null) {
							//Algo asi seria lo de ignorar para retirar dinero, o eso entiendo yo, si no simplemente serÌa que la lonja avise al terminar 
